...
2. Format and integration closure:
   ...
   canonical extension metadata active; next decide the Archery parity /
...
| 2 | ARROW-AUDIT-021 | Integration coverage still needs an Archery parity and physical-layout preservation decision. |

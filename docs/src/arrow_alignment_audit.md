...
| --- | --- | --- | --- | --- | --- |
| 1 | Official integration testing | `ARROW-AUDIT-021` | Keep the package-local Archery-style CLI as the current executable contract. | Decide whether to register Arrow.jl with upstream Archery or keep a package-local runner, then document the chosen boundary. | Integration CLI smoke tests, JSON fixture parity, and any upstream runner receipt if adopted. |

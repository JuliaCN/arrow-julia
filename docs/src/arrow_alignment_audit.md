...
| 3 | ARROW-AUDIT-030 | Strict performance-gate policy remains the next production evidence gap after adding the configurable same-client Flight upload-reuse soak. |

...
@testset "Arrow C Data Interface" begin
    ...
    @testset "imports non-zero offset C Data arrays" begin
        ...
        @test map(collect, collect(values)) ==
              [Int64[1, 2], Int64[], Int64[3, 4, 5], Int64[6]]
        ...
        dict_imported = CData.importtable(
            CData.schema_ptr(dict_exported),
            CData.array_ptr(dict_exported),
        )
        ...
        fixed_imported = CData.importtable(
            CData.schema_ptr(fixed_exported),
            CData.array_ptr(fixed_exported),
        )
        ...
        view_table = Arrow.Table(joinpath(@__DIR__, "reject_reason_trimmed.arrow"))
        ...
        view_imported = CData.importtable(
            CData.schema_ptr(view_exported),
            CData.array_ptr(view_exported),
        )
        @test isequal(

...
function flight_test_generated_protocol_formatter_surface()
    ...
    @test occursin("Autogenerated using ProtoBuf.jl v1.3.0", source)
    @test occursin("<: AbstractProtoBufMessage", source)
    @test occursin("_endpos::Int", source)
    @test !occursin("import gRPCClient", source)
    @test !occursin("# gRPCClient.jl BEGIN", source)

    protocol = Arrow.Flight.Protocol
    @test protocol.Ticket <: protocol.PB.AbstractProtoBufMessage

...
# GENERATED by tools/fbsgen.jl from apache/arrow format/File.fbs —
...
footerStart(b::FlatBuffers.Builder) = FlatBuffers.startobject!(b, 5)
...
footerStartRecordBatchesVector(b::FlatBuffers.Builder, numelems) =
    FlatBuffers.startvector!(b, 24, numelems, 8)
footerAddCustomMetadata(b::FlatBuffers.Builder, custom_metadata::FlatBuffers.UOffsetT) =
    FlatBuffers.prependoffsetslot!(b, 4, custom_metadata, 0)
footerStartCustomMetadataVector(b::FlatBuffers.Builder, numelems) =

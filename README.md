...
Current write-path notes:
  ...
  * `test/ipc_performance_report.jl` reports warmed IPC stream/file write, metadata-read, physical buffer-scan, and materialized element-scan timings plus allocation receipts for the core IPC path
